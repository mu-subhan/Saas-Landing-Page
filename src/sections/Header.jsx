...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setHasScroller(window.scrollY > 32);
    };
  ...
  return (
    <header
      className={clsx(
        ...
        hasScroller && "py-2 bg-black-100 backdrop-blur-[8px]"
      )}
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img src="/public/images/xora.svg" alt="logo" className="" />
        </a>
        <div
          className={clsx(
        ...
        >
          <div className=" max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[96ppx] h-[380px]translate-x-[-290px] -translate-x-1/2 rotate-90">
              <img
